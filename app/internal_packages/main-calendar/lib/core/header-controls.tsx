    ...
    return (
      ...
      <div className="view-controls">
        ...
        [{view: CalendarView.DAY, isDisabled: CalendarView.DAY === this.props.disabledViewButton,},
          {view: CalendarView.WEEK, isDisabled: CalendarView.WEEK === this.props.disabledViewButton},
          {view: CalendarView.MONTH, isDisabled: CalendarView.MONTH === this.props.disabledViewButton}
        ].map(buttonOptions => (
          <button
